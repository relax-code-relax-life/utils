...
export declare const dateParse: (str: string, fmt?: string | undefined) => Date;
...
export declare const weekRange: (startDate: Date, endDate: Date, splitDay?: number | undefined) => {
    start: Date;
    end: Date;
    duration: number;
}[];
